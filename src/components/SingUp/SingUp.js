      ...
      <Container component="main" maxWidth="xs">
        ...
        >
          ...
          <Typography component="h1" variant="h5">
            Bienvenido es un placer tenerte aquí
          </Typography>
          <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 3 }}>
            <Grid container spacing={2}>
              <Grid item xs={12} sm={6}>
                <TextField
                  autoComplete="Ingresa tu nombre"
                  name="Nombre"
                  required
                  fullWidth
                  id="Nombre"
            ...
            <Grid container justifyContent="flex-end">
              <Grid item>
                <LinkRouter to="/Login" variant="body2">
                  ...
                  {/*https://andygeek.com/posts/Fundamentos%20de%20React/posts/Comunicacion-entre-componentes-y-rutas-en-react/ */}
                </LinkRouter>
